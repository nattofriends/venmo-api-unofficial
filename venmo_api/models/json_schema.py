...
class PaymentParser:
    ...
    def get_target(self):
        return self.json.get(payment_request_json_format["target"]).get(
            payment_request_json_format["target_user"]
        )
...
mention_json_format = {"username": "username", "user": "user"}
